...
export default function DirectorProfileScreen() {
  ...
  useEffect(() => {
    ...
    setStudentCount(
      profile.student_count != null ? String(profile.student_count) : "",
    );
    ...
    >
      <View className="items-center pt-10 pb-5">
        ...
        <View className="mt-2 flex-row gap-2">
          ...
          {profile.is_partner && (
            <Chip label="École Partenaire" variant="orange" />
          )}
        </View>
      </View>
          ...
          <View className="gap-5">
            <View className="bg-white rounded-3xl p-6 shadow-deep border border-xporadia-border gap-5">
              <View className="flex-row gap-3">
                ...
                <StatBox
                  ...
                  label="Niveaux"
                  value={
                    profile.levels_taught.length
                      ? String(profile.levels_taught.length)
                      : "Non renseigné"
                  }
                />
              </View>
            ...
            >
              ...
              <Text className="text-white font-semibold">
                Modifier ma fiche établissement
              </Text>
            </Pressable>
          </View>
        ) : (
