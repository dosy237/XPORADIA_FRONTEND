...
type RegisterableRole = Extract<
  UserRole,
  "teacher" | "director" | "parent" | "company" | "student"
>;
...
const ROLE_CARDS: {
  ...
  },
  {
    ...
    description:
      "Obtenez votre certification et accédez au marché de l'emploi.",
    icon: BookIcon,
  },
  {
    value: "director",
...
export default function RegisterScreen() {
  ...
  const [status, setStatus] = useState<RegisterableRole | null>(
    inviteToken ? "teacher" : null,
  );
  ...
  return (
    ...
    >
      <AuthHeader
        ...
        subtitle="Rejoignez la communauté Xporadia"
        onBack={goBack}
        showBack
      />
        ...
        <View className="bg-white rounded-2xl p-6 gap-5 shadow-soft">
                ...
                return (
                  ...
                  >
                    ...
                    >
                      <RoleIcon
                        size={20}
                        color={isSelected ? "#FFFFFF" : "#5A6A8A"}
                      />
                    </View>
          ...
          {step === 2 && (
            <View className="gap-4">
              <Text className="text-xl font-bold text-xporadia-navy mb-1">
                Vos informations
              </Text>
              <Input
                label="Prénom"
              ...
              {status === "teacher" && (
                <>
                  ...
                  <Input
                    ...
                    onChangeText={setTeacherLocation}
                ...
                <>
                  ...
                  {children.map((child, index) => (
                    <Card
                      key={index}
                      variant="flat"
                      className="gap-3 bg-xporadia-bg"
                    >
                      <View className="flex-row justify-between items-center">
                        <Text className="font-medium text-xporadia-text-primary">
                          Enfant {index + 1}
                        </Text>
                        {children.length > 1 ? (
                          <Pressable
                            ...
                            hitSlop={8}
                          >
                            <Text className="text-xporadia-red text-sm font-medium">
                              Retirer
                            </Text>
                          </Pressable>
                        ) : null}
